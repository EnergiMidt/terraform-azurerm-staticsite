...
| <a name="input_custom_domain_name"></a> [custom\_domain\_name](#input\_custom\_domain\_name) | (Optional) A custom domain name for the static site. Example:<br/><br/>  name            = "ferdigmelding"<br/>  zone\_name       = "tensio.no"<br/>  validation\_type = "cname-delegation" | <pre>object({<br/>    name            = string<br/>    zone_name       = string<br/>    validation_type = string<br/>  })</pre> | `null` | no |
